...
const mapDispatchToProps = dispatch => ({
    ...
    onSubmit: product => {
        const payload = agent.Products.create(product);
        dispatch({ type: ADD_PRODUCT, payload })
    },
    onUnload: () =>
        dispatch({ type: ADD_PRODUCT_UNLOADED })
});
...
export default withRouter(withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(CreateProduct)));
